...
/**
 * Created by Chen on 2016/4/28.
 */
public class FormHotInfoAdapter extends BaseAdapter {
    private List<ForumData.DataBean.ItemsBean.PostAudioBean> postAudioBeanList=new ArrayList<>();
    private Context context;

    public FormHotInfoAdapter(List postAudioBeanList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ForumData.DataBean.ItemsBean.PostAudioBean postAudio=postAudioBeanList.get(position);
        ViewHolder holder;
        if (convertView==null) {
